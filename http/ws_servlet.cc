...
int32_t FunctionWSServlet::onConnect(yk::http::HttpRequest::ptr header
...
int32_t FunctionWSServlet::onClose(yk::http::HttpRequest::ptr header
                                     ,yk::http::WSSession::ptr session) {
    if(m_onClose) {
...
int32_t FunctionWSServlet::handle(yk::http::HttpRequest::ptr header
